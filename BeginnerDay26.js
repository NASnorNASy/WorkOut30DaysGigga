...
export default function BeginnerDay26Screen() {
  const [font] = useFonts({
  ...
  const [modalScreen19, setModalScreen19] = useState("none");
  const [modalScreen20, setModalScreen20] = useState("none");
  const [modalScreen21, setModalScreen21] = useState("none");
  const [modalScreen22, setModalScreen22] = useState("none");
  const [modalScreen23, setModalScreen23] = useState("none");
  const [modalScreen24, setModalScreen24] = useState("none");
  ...
  const NextScreen18 = () => {
    ...
    setModalScreen19("block");
  };
  const NextScreen19 = () => {
    setModalScreen19("none");
    setModalScreen20("block");
  };
  const NextScreen20 = () => {
    setModalScreen20("none");
    setModalScreen21("block");
  };
  const NextScreen21 = () => {
    setModalScreen21("none");
    setModalScreen22("block");
  };
  const NextScreen22 = () => {
    setModalScreen22("none");
    setModalScreen23("block");
  };
  const NextScreen23 = () => {
    setModalScreen23("none");
    setModalScreen24("block");
  };
  const NextScreen24 = () => {
    setModalScreen24("none");
    ...
    <ScrollView>
      ...
      >
        ...
        >
          <Image
            ...
            source={require("./assets/SidePlankLeftArm.jpg")}
          />
        </View>
        <View style={{ marginTop: 45 }}>
          <Text style={{ textAlign: "center", fontSize: 34, fontWeight: 500 }}>
      ...
      >
        ...
        >
          <Image
            ...
            source={require("./assets/SidePlankRightArm.jpg")}
          />
        </View>
        <View style={{ marginTop: 45 }}>
          <Text style={{ textAlign: "center", fontSize: 34, fontWeight: 500 }}>
      ...
      >
        ...
        <View style={{ marginTop: 45 }}>
          ...
          <Text style={{ textAlign: "center", fontSize: 29 }}>35 seconds</Text>
      ...
      >
        ...
        >
          <Image
            ...
            source={require("./assets/ObliqueCrunches.jpg")}
          />
        </View>
        <View style={{ marginTop: 45 }}>
          <Text style={{ textAlign: "center", fontSize: 34, fontWeight: 500 }}>
      ...
      >
        ...
        >
          ...
          <View style={styles.packsExercises}>
            ...
            />
            <View style={{ width: 200, marginTop: 35 }}>
              <Text style={styles.exerciseName}>Side Plank Left Arm</Text>
          ...
          <View style={styles.packsExercises}>
            ...
            />
            <View style={{ width: 200, marginTop: 35 }}>
              <Text style={styles.exerciseName}>Side Plank Right Arm</Text>
              <Text style={styles.exerciseAmount}>20 seconds</Text>
            </View>
          </View>
          <View style={styles.packsExercises}>
            ...
            <View style={{ width: 200, marginTop: 35 }}>
              ...
              <Text style={styles.exerciseAmount}>18 times</Text>
            </View>
          </View>
          <View style={styles.packsExercises}>
            <Image
            ...
            <View style={{ width: 200, marginTop: 35 }}>
              ...
              <Text style={styles.exerciseAmount}>35 seconds</Text>
            </View>
          </View>
          <View style={styles.packsExercises}>
            <Image
            ...
            />
            <View style={{ width: 200, marginTop: 35 }}>
              <Text style={styles.exerciseName}>Bicycle Crunches</Text>
              <Text style={styles.exerciseAmount}>18 times</Text>
            </View>
          </View>
          <View style={styles.packsExercises}>
            ...
            />
            <View style={{ width: 200, marginTop: 35 }}>
              <Text style={styles.exerciseName}>Boat Pose</Text>
              <Text style={styles.exerciseAmount}>25 seconds</Text>
            </View>
          </View>
          <View style={styles.packsExercises}>
          ...
          <View style={styles.packsExercises}>
            ...
            />
            <View style={{ width: 200, marginTop: 35 }}>
              <Text style={styles.exerciseName}>Flutter Kicks</Text>
              <Text style={styles.exerciseAmount}>20 seconds</Text>
            </View>
          </View>
          <View style={styles.packsExercises}>
            ...
            />
            <View style={{ width: 200, marginTop: 35 }}>
              <Text style={styles.exerciseName}>Oblique Crunches</Text>
              <Text style={styles.exerciseAmount}>18 times</Text>
            </View>
          </View>
          <View style={styles.packsExercises}>
            ...
            />
            <View style={{ width: 200, marginTop: 35 }}>
              <Text style={styles.exerciseName}>Mountain Climbers</Text>
              <Text style={styles.exerciseAmount}>25 seconds</Text>
            </View>
          </View>
          <View style={styles.packsExercises}>
