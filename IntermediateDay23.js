...
export default function IntermediateDay23Screen() {
  const [font] = useFonts({
  ...
  const [modalScreen25, setModalScreen25] = useState("none");
  const [modalScreen26, setModalScreen26] = useState("none");
  const [modalScreen27, setModalScreen27] = useState("none");
   const [modalScreen28, setModalScreen28] = useState("none");
  ...
  const goToNextModal = () => {
    ...
    if (modalScreen19 === "block") {
      setModalScreen19("none");
      setModalScreen20("block");
    }
    if (modalScreen20 === "block") {
      setModalScreen20("none");
      setModalScreen21("block");
    }
    if (modalScreen21 === "block") {
      setModalScreen21("none");
      setModalScreen22("block");
    }

    if (modalScreen22 === "block") {
      setModalScreen22("none");
      setModalScreen23("block");
    }
    if (modalScreen23 === "block") {
      setModalScreen23("none");
      setModalScreen24("block");
    }
    if (modalScreen24 === "block") {
      setModalScreen24("none");
      setModalScreen25("block");
    }
    if (modalScreen25 === "block") {
      setModalScreen25("none");
      setModalScreen26("block");
    }
     if (modalScreen26 === "block") {
      setModalScreen26("none");
      setModalScreen27("block");
    }

        if (modalScreen27 === "block") {
      setModalScreen27("none");
      setModalScreen28("block");
    }

    if (modalScreen28 === "block") {
      setModalScreen28("none");
...
{/*Модальне вікно 5*/}
  ...
  <View
    ...
    Russian Twists 
          ...
          <Text style={{ textAlign: "center", fontSize: 29 }}> 40 times </Text>
...
{/*Exercise 1 */}
        <View style={styles.exerciseBlock}>
            ...
            <View style={{ width: 200, marginTop: 35 }}>
              ...
              <Text style={styles.exerciseDuration}>35 seconds</Text>
            </View>
          </View>
      {/*Exercise 2 */}
          <View style={styles.exerciseBlock}>
     ...
     <View style={styles.exerciseBlock}>
      ...
      {/*Exercise 8 */}
          <View style={styles.exerciseBlock}>
            ...
            />
            <View style={{ width: 200, marginTop: 35 }}>
              <Text style={styles.exerciseTitle}> Side plank left arm</Text>
          ...
          <View style={styles.exerciseBlock}>
            ...
            />
            <View style={{ width: 200, marginTop: 35 }}>
              <Text style={styles.exerciseTitle}> Side plank right arm</Text>
              <Text style={styles.exerciseDuration}>20 seconds</Text>
            </View>
          </View>
        ...
        <View style={styles.exerciseBlock}>
            ...
            <View style={{ width: 200, marginTop: 35 }}>
              ...
              <Text style={styles.exerciseDuration}>40 times</Text>
            </View>
          </View>
          {/*Exercise 11 */}
       <View style={styles.exerciseBlock}>
  ...
  {/*Exercise 13 */}
          ...
          {/*Exercise 14 */}
            ...
            />
            <View style={{ width: 200, marginTop: 35 }}>
              <Text style={styles.exerciseTitle}>Reverse Crunches </Text>
              <Text style={styles.exerciseDuration}> 20 times</Text>
            </View>
          </View>
