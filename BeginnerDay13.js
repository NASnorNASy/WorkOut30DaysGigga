...
export default function BeginnerDay13Screen() {
  const [font] = useFonts({
    ...
    <ScrollView>
      ...
      >
        ...
        <View style={{ marginTop: 45 }}>
          ...
          <Text style={{ textAlign: "center", fontSize: 29 }}>12 times</Text>
      ...
      >
        ...
        <View style={{ marginTop: 45 }}>
          ...
          <Text style={{ textAlign: "center", fontSize: 29 }}>12 seconds</Text>
      ...
      >
        ...
        <View style={{ marginTop: 45 }}>
          ...
          <Text style={{ textAlign: "center", fontSize: 29 }}>15 seconds</Text>
        ...
        >
          ...
          <View style={styles.packsExercises}>
            ...
            <View style={{ width: 200, marginTop: 35 }}>
              ...
              <Text style={styles.exerciseAmount}>12 times</Text>
            </View>
          </View>
          <View style={styles.packsExercises}>
            <Image
          ...
          <View style={styles.packsExercises}>
            ...
            <View style={{ width: 200, marginTop: 35 }}>
              ...
              <Text style={styles.exerciseAmount}>12 seconds</Text>
            </View>
          </View>
          <View style={styles.packsExercises}>
            <Image
          ...
          <View style={styles.packsExercises}>
            ...
            <View style={{ width: 200, marginTop: 35 }}>
              ...
              <Text style={styles.exerciseAmount}>15 seconds</Text>
            </View>
          </View>
          <View style={styles.packsExercises}>
            <Image
